...
mod tests {
    ...
    fn test_values(x: u16, y: u16) {
        println!("x:{} y:{}", x, y);
        let res: f64 = map(x, y);
        assert_eq!(reverse_map(res), (x, y));
        // println!(" -> {:?}", );
    }
    ...
    fn borders() {
        test_values(0, 0);
        test_values(0, u16::MAX);
        test_values(u16::MAX, u16::MAX);
        test_values(u16::MAX, u16::MAX);
    }
    ...
    fn test_randoms() {
        ...
        for _i in 0..1000 {
            test_values(rng.gen_range(0..=u16::MAX), rng.gen_range(0..=u16::MAX));
        }
    }
}
